    ...
    const fetchAttendance = async () => {
      try {
        ...
        const attendanceResponse = await axios.get(
          `https://school-project-backend-p17b.onrender.com/api/v1/attendance/attendance-mgmt/all-attendance?startDate=2024-11-15&endDate=2024-12-20`,
          {
            headers: {
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <p className="mt-2">Start Date</p>
              ...
              <input
                ...
                className="px-4 py-2 rounded-md border border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"
              />
              <button className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700" onClick={() => handleSearch()}>
                Search
              </button>
            </div>
          </div>

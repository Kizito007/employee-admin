...
import { convertBase64ImageToJpg } from "../add-attendance/convertBase64ToJpg";
    ...
    const compareImages = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `https://school-project-backend-p17b.onrender.com/api/v1/employee/employee-mgmt/sign-out-face/${employeeId}/${attendanceId}`, {},
